...
t = 22.5  # Celsius
viscosity = 5 * 10**-3  # mPa.s to Pa.s
...
def objective_function(params):
    ...
    d10 = (0.155 * bead_size) + (0.055 * agitator_speed) + (0.015 * flow_rate) + (0.005 * batch_size) + (-k * viscosity * (1 + t)) + (m * 2 * 10**-6)
    d50 = (0.155 * bead_size) + (0.055 * agitator_speed) + (0.015 * flow_rate) + (0.005 * batch_size) + (-k * viscosity * (1 + t)) + (m * 4 * 10**-6)
...
print("Optimized Operating Conditions:")
